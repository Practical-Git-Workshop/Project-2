! function(e, t) {
  ...
  function j(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = ot._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && At(r) && (o[a] = ot._data(r, "olddisplay", k(r.nodeName)))) : o[a] || (i = At(r), (n && "none" !== n || !i) && ot._data(r, "olddisplay", i ? n : ot.css(r, "display"))));
  ...
  function D(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === n && (a += ot.css(e, n + jt[o], !0, i)), r ? ("content" === n && (a -= ot.css(e, "padding" + jt[o], !0, i)), "margin" !== n && (a -= ot.css(e, "border" + jt[o] + "Width", !0, i))) : (a += ot.css(e, "padding" + jt[o], !0, i), "padding" !== n && (a += ot.css(e, "border" + jt[o] + "Width", !0, i)));
    return a
  }
  ...
  function F(e, t, n) {
    ...
    })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = ot.css(e, "display"), c = k(e.nodeName), "none" === u && (u = c), "inline" === u && "none" === ot.css(e, "float") && (rt.inlineBlockNeedsLayout && "inline" !== c ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", rt.shrinkWrapBlocks() || d.always(function() {
  ...
  function B(e, t, n) {
    ...
    for (O(c, u.opts.specialEasing); a > o; o++)
      if (r = xn[o].call(u, e, c, u.opts)) return r;
  ...
  ot.fn = ot.prototype = {
    ...
    for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || ot.isFunction(a) || (a = {}), s === l && (a = this, s--); l > s; s++)
      if (null != (i = arguments[s]))
        for (r in i) e = a[r], n = i[r], a !== n && (u && n && (ot.isPlainObject(n) || (t = ot.isArray(n))) ? (t ? (t = !1, o = e && ot.isArray(e) ? e : []) : o = e && ot.isPlainObject(e) ? e : {}, a[r] = ot.extend(u, o, n)) : void 0 !== n && (a[r] = n));
    return a
  }, ot.extend({
  ...
  var ct = function(e) {
    function t(e, t, n, r) {
      ...
      if ((t ? t.ownerDocument || t : z) !== H && L(t), t = t || H, n = n || [], !e || "string" != typeof e) return n;
    ...
    function h(e, t, n) {
      ...
      return t.first ? function(t, n, o) {
        ...
        if (a) {
          ...
          for (; t = t[r];)
            if (1 === t.nodeType || i) {
              if (l = t[$] || (t[$] = {}), (s = l[r]) && s[0] === W && s[1] === o) return u[2] = s[2];
    ...
    function y(e) {
      for (var t, n, r, i = e.length, o = N.relative[e[0].type], a = o || N.relative[" "], s = o ? 1 : 0, l = h(function(e) {
        ...
        if (n = N.relative[e[s].type]) c = [h(m(c), n)];
          ...
          if (n = N.filter[e[s].type].apply(null, e[s].matches), n[$]) {
    ...
    var T, C, N, k, E, S, j, A, D, L, H, q, _, M, F, O, B, $ = "sizzle" + -new Date,
      z = e.document,
      W = 0,
      P = 0,
      R = n(),
    ...
    C = t.support = {}, E = t.isXML = function(e) {
      ...
      var t, n = e ? e.ownerDocument || e : z,
        r = n.defaultView;
      return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, q = n.documentElement, _ = !E(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
        L()
        ...
        return q.appendChild(e).id = $, !n.getElementsByName || !n.getElementsByName($).length
        ...
        return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !C.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === z && B(z, e) ? -1 : t === n || t.ownerDocument === z && B(z, t) ? 1 : A ? tt.call(A, e) - tt.call(A, t) : 0 : 4 & r ? -1 : 1)
      } : function(e, t) {
        if (e === t) return D = !0, 0;
        var r, i = 0,
          o = e.parentNode,
      ...
      filter: {
        ...
        CLASS: function(e) {
          var t = R[e + " "];
          return t || (t = new RegExp("(^|" + rt + ")" + e + "(" + rt + "|$)")) && R(e, function(e) {
          ...
          return 1 === r && 0 === i ? function(e) {
            ...
            if (g) {
              ...
              if (h = [a ? g.firstChild : g.lastChild], a && y) {
                for (c = g[$] || (g[$] = {}), u = c[e] || [], p = u[0] === W && u[1], f = u[0] === W && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                  if (1 === d.nodeType && ++f && d === t) {
                    c[e] = [W, p, f];
                    break
                  }
              } else if (y && (u = (t[$] || (t[$] = {}))[e]) && u[0] === W) f = u[1];
              else
                for (;
                  (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[$] || (d[$] = {}))[e] = [W, f]), d !== t)););
        ...
        PSEUDO: function(e, n) {
          ...
          return o[$] ? o(n) : o.length > 1 ? (i = [e, e, "", n], N.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, t) {
    ...
    return d.prototype = N.filters = N.pseudos, N.setFilters = new d, S = t.compile = function(e, t) {
      var n, r = [],
        ...
        o = X[e + " "];
      if (!o) {
        for (t || (t = f(e)), n = t.length; n--;) o = y(t[n]), o[$] ? r.push(o) : i.push(o);
        o = X(e, b(i, r))
      }
      return o
    }, C.sortStable = $.split("").sort(U).join("") === $, C.detectDuplicates = !!D, L(), C.sortDetached = i(function(e) {
  ...
  ot.Callbacks = function(e) {
    ...
    when: function(e) {
      ...
      if (a > 1)
        for (t = new Array(a), n = new Array(a), r = new Array(a); a > i; i++) o[i] && ot.isFunction(o[i].promise) ? o[i].promise().done(u(i, r, o)).fail(l.reject).progress(u(i, n, t)) : --s;
      ...
      if (g && (c = g.events)) {
        for (t = (t || "").match(xt) || [""], u = t.length; u--;)
          if (s = Ft.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
            ...
            for (p in c) ot.event.remove(e, p + t[u], n, r, !0);
  ...
  Gt.optgroup = Gt.option, Gt.tbody = Gt.tfoot = Gt.colgroup = Gt.caption = Gt.thead, Gt.th = Gt.td, ot.extend({
    clone: function(e, t, n) {
      ...
      if (rt.html5Clone || ot.isXMLDoc(e) || !$t.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Kt.innerHTML = e.outerHTML, Kt.removeChild(o = Kt.firstChild)), !(rt.noCloneEvent && rt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ot.isXMLDoc(e)))
    ...
    buildFragment: function(e, t, n, r) {
      for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
        ...
        for (s = s || f.appendChild(t.createElement("div")), l = (Pt.exec(o) || ["", ""])[1].toLowerCase(), c = Gt[l] || Gt._default, s.innerHTML = c[1] + o.replace(Wt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        if (!rt.leadingWhitespace && zt.test(o) && p.push(t.createTextNode(zt.exec(o)[0])), !rt.tbody)
          for (o = "table" !== l || Rt.test(o) ? "<table>" !== c[1] || Rt.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) ot.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
      ...
      for (s && f.removeChild(s), rt.appendChecked || ot.grep(g(p, "input"), v), h = 0; o = p[h++];)
        if ((!r || -1 === ot.inArray(o, r)) && (a = ot.contains(o.ownerDocument, o), s = g(f.appendChild(o), "script"), a && w(s), n))
          for (i = 0; o = s[i++];) Vt.test(o.type || "") && n.push(o);
      return s = null, f
    },
    ...
    html: function(e) {
      return Dt(this, function(e) {
        ...
        if (!("string" != typeof e || Xt.test(e) || !rt.htmlSerialize && $t.test(e) || !rt.leadingWhitespace && zt.test(e) || Gt[(Pt.exec(e) || ["", ""])[1].toLowerCase()])) {
          e = e.replace(Wt, "<$1></$2>");
          try {
    ...
    domManip: function(e, t) {
      ...
      if (u && (s = ot.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
        ...
        if (i)
          for (a = o[o.length - 1].ownerDocument, ot.map(o, x), l = 0; i > l; l++) r = o[l], Vt.test(r.type || "") && !ot._data(r, "globalEval") && ot.contains(a, r) && (r.src ? ot._evalUrl && ot._evalUrl(r.src) : ot.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Yt, "")));
        s = n = null
      }
      return this
    }
  ...
  }), ot.cssHooks.marginRight = E(rt.reliableMarginRight, function(e, t) {
    return t ? ot.swap(e, {
  ...
  var Cn, Nn, kn = ot.expr.attrHandle,
  ...
  ot.fn.extend({
    ...
    removeAttr: function(e, t) {
      var n, r, i = 0,
        o = t && t.match(xt);
      if (o && 1 === e.nodeType)
        for (; n = o[i++];) r = ot.propFix[n] || n, ot.expr.match.bool.test(n) ? jn && Sn || !En.test(n) ? e[r] = !1 : e[ot.camelCase("default-" + n)] = e[r] = !1 : ot.attr(e, n, ""), e.removeAttribute(Sn ? n : r)
    },
    attrHooks: {
      type: {
        set: function(e, t) {
    ...
    set: function(e, t, n) {
      return t === !1 ? ot.removeAttr(e, n) : jn && Sn || !En.test(n) ? e.setAttribute(!Sn && ot.propFix[n] || n, n) : e[ot.camelCase("default-" + n)] = e[n] = !0, n
    }
  }, ot.each(ot.expr.match.bool.source.match(/\w+/g), function(e, t) {
    var n = kn[t] || ot.find.attr;
    kn[t] = jn && Sn || !En.test(t) ? function(e, t, r) {
      var i, o;
  ...
  Mn = Rn.exec(Fn.toLowerCase()) || [], ot.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ajaxSettings: {
    ...
    ajax: function(e, t) {
      ...
      var r, i, o, a, s, l, u, c, d = ot.ajaxSetup({}, t),
        ...
        w = {
          ...
          getResponseHeader: function(e) {
            ...
            if (2 === b) {
              if (!c)
                for (c = {}; t = $n.exec(a);) c[t[1].toLowerCase()] = t[2];
              t = c[e.toLowerCase()]
            }
      ...
      if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || Fn) + "").replace(On, "").replace(Pn, Mn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(xt) || [""], null == d.crossDomain && (r = Rn.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === Mn[1] && r[2] === Mn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Mn[3] || ("http:" === Mn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ot.param(d.data, d.traditional)), z(In, d, t, w), 2 === b) return w;
  ...
  ot.offset = {
    ...
    ot.cssHooks[t] = E(rt.pixelPosition, function(e, n) {
  ...
  {
    var e = $("#navigation-menu"),
      t = $("#js-mobile-menu");
    $(".sign-up")
  }
  $(t).on("click", function(t) {
    t.preventDefault(), e.slideToggle(function() {
      e.is(":hidden") && e.removeAttr("style")
    })
  }), $(".nav .nav-link").click(function() {
    $(".nav .nav-link").each(function() {
      $(this).removeClass("active-nav-item")
    }), $(this).addClass("active-nav-item"), $(".nav .more").removeClass("active-nav-item")
  })
}), $(document).ready(function() {
  var e = {
    results: [{
      user: {
        ...
        location: {
          street: "1541 e broadway st",
          city: "des moines",
          state: "iawaii",
          zip: "45151"
        },
        email: "eugene.allen76@example.com",
        username: "crazymouse54",
        password: "mustang1",
        salt: "rjLiUJux",
        md5: "f0d622876d06e6d6b744aeaa53c80bf0",
        sha1: "3c721ced81f864d5e3d0524242df340bf78de023",
        sha256: "88569d419e2f9efeddcb1ff55b4779b456a73470fc6499b0eee2cfad1f7656c0",
        registered: "1207263373",
        dob: "84526771",
        phone: "(623)-877-3081",
        cell: "(729)-798-6973",
        SSN: "949-74-5018",
        picture: "http://api.randomuser.me/portraits/men/12.jpg"
      },
      seed: "5636b133097067d",
      version: "0.4"
    }, {
      user: {
        gender: "female",
        ...
        location: {
          street: "4084 victoria dr",
          city: "seymour",
          state: "indiana",
          zip: "89607"
        },
        email: "alexis.rogers91@example.com",
        username: "ticklishcat30",
        password: "sierra",
        salt: "k86smUA6",
        md5: "ebb517be382ad075ab9da641dc652238",
        sha1: "5e9dec27fe24ed2e0ee5cb5e58706d69ab070cf1",
        sha256: "ea7d0e0998763be841a6853873c568750ed114a915363092ccbab9f401ac4536",
        registered: "1388307288",
        dob: "473997462",
        phone: "(856)-539-7686",
        cell: "(267)-179-6981",
        SSN: "585-56-3435",
        picture: "http://api.randomuser.me/portraits/women/16.jpg"
      },
      seed: "c7423fe4a2bc426",
      version: "0.4"
    }, {
      user: {
        gender: "female",
        ...
        location: {
          street: "2307 rolling green rd",
          city: "missoula",
          state: "north carolina",
          zip: "36916"
        },
        email: "glenda.garcia81@example.com",
        username: "bigmouse881",
        password: "whiskers",
        salt: "VYXoMVHl",
        md5: "be9700612296284e57b0199ca1fd2f07",
        sha1: "d6c9d61c57baadb78d27980ec3d8617a01215b57",
        sha256: "b04a11df46f461de5e339128359d97cdeaa839cad54386ca23ae50ccd8b086e2",
        registered: "1085189303",
        dob: "61730256",
        phone: "(813)-857-2744",
        cell: "(738)-614-1483",
        SSN: "917-63-3022",
      ...
      user: {
        ...
        location: {
          street: "1650 rudder rd",
          city: "waxahachie",
          state: "louisiana",
          zip: "54050"
        },
        email: "kevin.fernandez63@example.com",
        username: "crazykoala59",
        password: "lancer",
        salt: "iGgxv9rD",
        md5: "6607d49736504748ffb13c759e83dd54",
        sha1: "3f61cda71d1645df3cf989f499f64621f93425cb",
        sha256: "edfe5c44e2410788a6098d886347a3b09fd97059900c470ffa6f31d60137104e",
        registered: "1368038302",
        dob: "386994428",
        phone: "(999)-872-4617",
        cell: "(825)-173-8799",
        SSN: "120-25-3656",
      ...
      user: {
        ...
        location: {
          street: "8242 first st",
          city: "flowermound",
          state: "massachusetts",
          zip: "22347"
        },
        email: "adrian.owens16@example.com",
        username: "bluefrog368",
        password: "online",
        salt: "8iutBZVy",
        md5: "09fd1c62d0f5d834e626f9363857aa36",
        sha1: "20f17a0ce9ccd385e91c62aae51187a3abf62de4",
        sha256: "ce7311f5af12ab3f9fe3f54878ede43036c655541d3a1bbc5febb23964b8c60f",
        registered: "1011383530",
        dob: "16293299",
        phone: "(283)-220-6762",
        cell: "(132)-999-9774",
        SSN: "770-35-6261",
        picture: "http://api.randomuser.me/portraits/men/47.jpg"
      },
      seed: "6f1aef865bf02bd",
      version: "0.4"
    }, {
      user: {
        gender: "female",
        ...
        location: {
          street: "2016 vinecrest ave",
          city: "salt lake city",
          state: "florida",
          zip: "73382"
        },
        email: "tammy.austin96@example.com",
        username: "ticklishpeacock749",
        password: "sakura",
        salt: "MaQAffUk",
        md5: "ab6abbedc4be82052a9f7add5171fc04",
        sha1: "e52d9981255136eb253ed1df00e85153e7032718",
        sha256: "745c8026a6f65f7702d0760d71c71e9431c84140d8257110f4e834ad1ce20ce6",
        registered: "1009841304",
        dob: "469976558",
        phone: "(224)-375-4477",
        cell: "(653)-369-9309",
        SSN: "768-76-2658",
      ...
      user: {
        ...
        email: "jessie.larson29@example.com",
        username: "beautifulbutterfly736",
        password: "utopia",
        salt: "v3REt6Uk",
        md5: "cdfe8f592fd258a32b126453fabc0c43",
        sha1: "66029d1d3261b4dbebfd6be1c0b84e5adcb4a844",
        sha256: "ccfce8d50b8b9b2cadee52d249ddcf38da0d9592850dc2988018189b9e99074a",
        registered: "941977092",
        dob: "276428732",
        phone: "(416)-357-3375",
        cell: "(303)-424-7963",
        SSN: "861-24-4626",
      ...
      user: {
        ...
        location: {
          street: "4476 airport ave",
          city: "nashville",
          state: "kansas",
          zip: "32028"
        },
        email: "flenn.ruiz75@example.com",
        username: "goldenelephant633",
        password: "oblivion",
        salt: "iM4W2byW",
        md5: "f93cae998d0545e9acc5f4d086c93cac",
        sha1: "c710aea0ff4aa791feedc36f1963facab4127b26",
        sha256: "e32cfbb991bf420cd55b7c83e698205b5829962db3d0fcbd77790bba11e90daa",
        registered: "1136461028",
        dob: "335773959",
        phone: "(719)-629-1596",
        cell: "(624)-746-6573",
        SSN: "946-75-1023",
        picture: "http://api.randomuser.me/portraits/men/98.jpg"
      },
      seed: "b25d5fda498d8cf",
      version: "0.4"
    }, {
      user: {
        gender: "male",
        ...
        location: {
          street: "8306 depaul dr",
          city: "denver",
          state: "utah",
          zip: "11086"
        },
        email: "lester.montgomery84@example.com",
        username: "heavyrabbit799",
        password: "rhino",
        salt: "rDsBbjAz",
        md5: "5320b91091c7f2b28fa8e4ef4d2b2a99",
        sha1: "bc615b4ceeb5e488c0e3d04f9f26960d3f4ed84c",
        sha256: "680462f2c40fb572e771342854e9990d7b69ab36005aded572610fd2395c13af",
        registered: "1085004154",
        dob: "87618483",
        phone: "(473)-964-3268",
        cell: "(856)-374-1977",
        SSN: "464-79-9447",
      ...
      user: {
        ...
        location: {
          street: "6144 rolling green rd",
          city: "long beach",
          state: "minnesota",
          zip: "47571"
        },
        email: "benjamin.moore30@example.com",
        username: "lazybear626",
        password: "trident",
        salt: "wEgLrmdO",
        md5: "20990ad570b66663825a06215139d173",
        sha1: "73d6db6214a6ccaac6b3410d4a4a3f95ec4c7196",
        sha256: "8f99b319a73bacd94f7ccb47f39547744a574a1003dd6330a3650e2c4fa93532",
        registered: "1310506351",
        dob: "202705525",
        phone: "(439)-587-5907",
        cell: "(716)-336-5631",
        SSN: "557-67-7291",
        picture: "http://api.randomuser.me/portraits/men/95.jpg"
      },
      seed: "640e7ad7c011a29",
      version: "0.4"
    }, {
      user: {
        gender: "male",
        ...
        location: {
          street: "4990 pockrus page rd",
          city: "fort collins",
          state: "ohio",
          zip: "16427"
        },
        email: "victor.washington51@example.com",
        username: "brownladybug592",
        password: "fish",
        salt: "a1lEigeA",
        md5: "f5249bdcde70b53e9546df3fa1dd8334",
        sha1: "4b711f1e2c7e49b8e758800b5d3d40031993bc81",
        sha256: "02428114caa88379ea4fabe2c2e41882e4ff779c09ab0b904f7b0be150463633",
        registered: "1040251808",
        dob: "272892368",
        phone: "(857)-817-8156",
        cell: "(432)-519-7979",
        SSN: "914-42-2807",
      ...
      user: {
        ...
        location: {
          street: "3783 e little york rd",
          city: "escondido",
          state: "california",
          zip: "11328"
        },
        email: "jack.terry48@example.com",
        username: "blackdog993",
        password: "girlies",
        salt: "rhNe5Jty",
        md5: "c8abd07f34e4bca437ea1a14d933afe8",
        sha1: "925de6b2bc8c16fdce66d2454075a264ea32c02a",
        sha256: "b955be3ae56c78756468204ef750e9172bfb3e3e672c6081c217ab34214badfe",
        registered: "1329400088",
        dob: "44346331",
        phone: "(348)-794-9001",
        cell: "(588)-896-8578",
        SSN: "545-76-7098",
        picture: "http://api.randomuser.me/portraits/men/46.jpg"
      },
      seed: "d9a2b8cf3d59723",
      version: "0.4"
    }]
  };
  $(".team .member").each(function(t) {
    var n = e.results[t].user;
    $(this).children(".member-name").first().html(n.name.first + " " + n.name.last), $(this).children(".member-picture").first().attr("src", n.picture)
  })
});
